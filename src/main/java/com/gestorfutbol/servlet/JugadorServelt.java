...
public class JugadorServelt extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        JugadorDTO jugadorDTO = new JugadorDTO(request.getParameter("nombreJugador"),
                Integer.parseInt(request.getParameter("espaldar")),
                equipoService.obtenerEquipoPorId(idEquipo)
        );
...
@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<JugadorDTO> jugadoresDeEquipo = jugadorService.listarJugadoresPorEquipo(equipoService.obtenerEquipoPorId(idEquipo));
